...
public class Main {
    public static void main(String[] args) {
        for (int fileNum = 0; fileNum < 10; fileNum++) {
            File dataFile = new File(String.format("src/main/resources/ins_20_10_0%d.txt", fileNum));
            ...
            File outputFile = new File(String.format("src/main/resources/result_20_10_0%d.csv", fileNum));
